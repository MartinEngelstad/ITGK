...
if choice01.lower() == 'open door' or choice01.lower() == 'try door':
    print('The door is locked')
elif choice01.lower() == 'jump out window' or choice01.lower() == 'climb out window':
    print('You fall to your death')
elif choice01.lower() == 'eat breakfast' or choice01.lower() == 'eat food':
