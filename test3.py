...
if "port salut" in cheeses:
    print(cheeses["port salut"])
 

print("Oppgave b)")
#TODO løs oppgave b her:
infected_drawers = ["B13", "B14", "B15", "A234", "A235", "C31"]
infected_cheeses = []
for cheese,drawers in cheeses.items():
    for drawer in drawers:
        for i_drawer in infected_drawers:
            if i_drawer in drawer:
                if cheese not in infected_cheeses:
                    infected_cheeses.append(cheese)
                print('The',cheese,'in drawer',drawer,'is infected')
